...
public class EnemySpawnerFireLevel : MonoBehaviour
{
    ...
    private void SpawnSingleEnemy()
    {
        ...
        Instantiate(enemyPrefab, new Vector3(spawnXPosition, spawnYPosition, 0), Quaternion.Euler(0, 0, 0)).transform.Rotate(0,180,0);
    }
